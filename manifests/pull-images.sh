...
docker pull registry.opensource.zalan.do/acid/postgres-operator-ui:v1.6.0
...
docker tag registry.opensource.zalan.do/acid/postgres-operator-ui:v1.6.0 docker-personal.artifacts.dbccloud.dk/mran/postgres-operator-ui:demo
...
docker push docker-personal.artifacts.dbccloud.dk/mran/postgres-operator-ui:demo
